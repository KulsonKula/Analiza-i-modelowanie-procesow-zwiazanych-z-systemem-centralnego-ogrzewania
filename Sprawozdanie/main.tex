...
\begin{table}[!h]
  ...
  \resizebox{\textwidth}{!}{
    \begin{tabular}{|c|cccccccccccc|}
      ...
      Model 1              & \multicolumn{1}{c|}{0.022}     & \multicolumn{1}{c|}{0.00740} & \multicolumn{1}{c|}{0.037} & \multicolumn{1}{c|}{0.00670} & \multicolumn{1}{c|}{0.0110} & \multicolumn{1}{c|}{0.0039} & \multicolumn{1}{c|}{0.00840} & \multicolumn{1}{c|}{0.00950} & \multicolumn{1}{c|}{0.0072} & \multicolumn{1}{c|}{0.220} & \multicolumn{1}{c|}{0.01000} & 0.190 \\ \hline
...
\begin{table}[!h]
  ...
  \resizebox{\textwidth}{!}{
    \begin{tabular}{|c|c|c|c|c|c|c|}
      ...
      Model krótki & 0.39                                                              & 1.00                                                             & 0.66                                                               & 0.15                                                       & 0.01                                                       & 0.44                                                             \\ \hline
      Model długi  & 0.64                                                              & 1.                                                               & 0.54                                                               & 0.04                                                       & 0.19                                                       & 0.81                                                             \\ \hline
    \end{tabular}
  }
\end{table}
...
\begin{table}[!h]
  ...
  \resizebox{\textwidth}{!}{
    \begin{tabular}{|c|c|c|c|c|c|}
      \hline
      \begin{tabular}[c]{@{}c@{}}Temperatura \\ zewnętrzna\end{tabular} & \begin{tabular}[c]{@{}c@{}}Wilgotność\\  zewnętrzna\end{tabular} & \begin{tabular}[c]{@{}c@{}}Ciśnienie\\  atmosferyczne\end{tabular} & \begin{tabular}[c]{@{}c@{}}Prędkość\\  wiatru\end{tabular} & \begin{tabular}[c]{@{}c@{}}Kierunek\\  wiatru\end{tabular} & \begin{tabular}[c]{@{}c@{}}Wilgotność \\ wewnętrzna\end{tabular} \\ \hline
      0.82                                                              & 1.00                                                             & 0.78                                                               & 0.47                                                       & 0.50                                                       & 0.69                                                             \\ \hline
      0.83                                                              & 1.00                                                             & 0.83                                                               & 0.48                                                       & 0.58                                                       & 0.73                                                             \\ \hline\end{tabular}
  }
\end{table}
...
\begin{table}[!h]
  ...
  \resizebox{\textwidth}{!}{
    \begin{tabular}{|c|c|c|c|c|c|c|}
      \hline
                                                                         & \begin{tabular}[c]{@{}c@{}}Temperatura \\ zewnętrzna\end{tabular} & \begin{tabular}[c]{@{}c@{}}Wilgotność\\  zewnętrzna\end{tabular} & \begin{tabular}[c]{@{}c@{}}Ciśnienie\\ atmosferyczne\end{tabular} & \begin{tabular}[c]{@{}c@{}}Prędkość\\ wiatru\end{tabular} & \begin{tabular}[c]{@{}c@{}}Kierunek\\ wiatru\end{tabular} & \begin{tabular}[c]{@{}c@{}}Wilgotność\\  wewnętrzna\end{tabular} \\ \hline
      \multirow{3}{*}{\begin{tabular}[c]{@{}c@{}}Model\\ 1\end{tabular}} & 1.00                                                              & 0.08                                                             & 0.68                                                              & 0.39                                                      & 0.04                                                      & 0.81                                                             \\ \cline{2-7}
                                                                         & 1.00                                                              & 0.37                                                             & 0.58                                                              & 0.28                                                      & 0.22                                                      & 0.15                                                             \\ \cline{2-7}
                                                                         & 0.82                                                              & 0.14                                                             & 1.00                                                              & 0.34                                                      & 0.05                                                      & 0.62                                                             \\ \hline
      \multirow{3}{*}{\begin{tabular}[c]{@{}c@{}}Model\\ 2\end{tabular}} & 1.00                                                              & 0.79                                                             & 0.41                                                              & 0.20                                                      & 0.25                                                      & 0.08                                                             \\ \cline{2-7}
...
\begin{table}[!h]
  ...
  \resizebox{\textwidth}{!}{
    \begin{tabular}{|c|c|c|c|c|c|c|c|}
      ...
      \multirow{4}{*}{\begin{tabular}[c]{@{}c@{}}Model\\ 1\end{tabular}} & 10                                                     & 0.70                                                              & 1.00                                                             & 0.12                                                              & 0.08                                                      & 0.42                                                      & 0.39                                                            \\ \cline{2-8}
      ...
      \multirow{4}{*}{\begin{tabular}[c]{@{}c@{}}Model\\ 2\end{tabular}} & 10                                                     & 1.00                                                              & 0.53                                                             & 0.52                                                              & 0.15                                                      & 0.19                                                      & 0.00                                                            \\ \cline{2-8}
...
\begin{table}[!h]
  ...
  \resizebox{\textwidth}{!}{
    \begin{tabular}{|c|c|c|c|c|c|c|c|c|}
      \hline
                                                                         & Metoda           & \begin{tabular}[c]{@{}c@{}}Temperatura\\ SET\end{tabular} & \begin{tabular}[c]{@{}c@{}}Temperatura \\ zewnętrzna\end{tabular} & \begin{tabular}[c]{@{}c@{}}Wilgotność\\  zewnętrzna\end{tabular} & \begin{tabular}[c]{@{}c@{}}Ciśnienie\\ atmosferyczne\end{tabular} & \begin{tabular}[c]{@{}c@{}}Prędkość\\ wiatru\end{tabular} & \begin{tabular}[c]{@{}c@{}}Kierunek\\ wiatru\end{tabular} & \begin{tabular}[c]{@{}c@{}}Wilgotność\\ wewnętrzna\end{tabular} \\ \hline
      \multirow{3}{*}{\begin{tabular}[c]{@{}c@{}}Model\\ 1\end{tabular}} & PFI              & 1 00                                                      & 0.50                                                              & 0.00                                                             & 0.48                                                              & 0.86                                                      & 0.87                                                      & 0.46                                                            \\ \cline{2-9}
                                                                         & Wagi wejściowe   & 1.00                                                      & 0.34                                                              & 0.35                                                             & 0.41                                                              & 0.22                                                      & 0.31                                                      & 0.31                                                            \\ \cline{2-9}
                                                                         & LIME$_{śr(100)}$ & 1.00                                                      & 0.11                                                              & 0.40                                                             & 0.34                                                              & 0.09                                                      & 0.05                                                      & 0.01                                                            \\ \hline
      \multirow{3}{*}{\begin{tabular}[c]{@{}c@{}}Model\\ 2\end{tabular}} & PFI              & 1 00                                                      & 0.62                                                              & 0.00                                                             & 0.13                                                              & 0.58                                                      & 0.73                                                      & 0.11                                                            \\ \cline{2-9}
