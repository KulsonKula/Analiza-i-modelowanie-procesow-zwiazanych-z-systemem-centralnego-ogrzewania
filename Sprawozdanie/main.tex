...
\begin{table}[!h]
  ...
  \resizebox{\textwidth}{!}{
    \begin{tabular}{|c|c|c|c|c|c|}
      \hline
      \begin{tabular}[c]{@{}c@{}}Temperatura \\ zewnętrzna\end{tabular} & \begin{tabular}[c]{@{}c@{}}Wilgotność\\  zewnętrzna\end{tabular} & \begin{tabular}[c]{@{}c@{}}Ciśnienie\\  atmosferyczne\end{tabular} & \begin{tabular}[c]{@{}c@{}}Prędkość\\  wiatru\end{tabular} & \begin{tabular}[c]{@{}c@{}}Kierunek\\  wiatru\end{tabular} & \begin{tabular}[c]{@{}c@{}}Wilgotność \\ wewnętrzna\end{tabular} \\ \hline
      0.63                                                              & 1.00                                                             & 0.31                                                               & 0.13                                                       & 0.22                                                       & 0.72                                                             \\ \hline
    \end{tabular}
  }
\end{table}\\
...
\begin{table}[!h]
  ...
  \resizebox{\textwidth}{!}{
    \begin{tabular}{|c|c|c|c|c|c|}
      \hline
      \begin{tabular}[c]{@{}c@{}}Temperatura \\ zewnętrzna\end{tabular} & \begin{tabular}[c]{@{}c@{}}Wilgotność\\  zewnętrzna\end{tabular} & \begin{tabular}[c]{@{}c@{}}Ciśnienie\\  atmosferyczne\end{tabular} & \begin{tabular}[c]{@{}c@{}}Prędkość\\  wiatru\end{tabular} & \begin{tabular}[c]{@{}c@{}}Kierunek\\  wiatru\end{tabular} & \begin{tabular}[c]{@{}c@{}}Wilgotność \\ wewnętrzna\end{tabular} \\ \hline
      1.00                                                              & 0.46                                                             & 0.63                                                               & 0.41                                                       & 0.20                                                       & 0.00                                                             \\ \hline
    \end{tabular}
  }
\end{table}
...
\begin{table}[!h]
  ...
  \begin{tabular}{|c|c|c|}
    ...
    \begin{tabular}[c]{@{}c@{}}Model\\ 1\end{tabular} & 0.0706                                                              & 0.0691                                                            \\ \hline
    \begin{tabular}[c]{@{}c@{}}Model\\ 2\end{tabular} & 0.0262                                                              & 0.0230                                                            \\ \hline
  \end{tabular}
\end{table}
  ...
  \resizebox{\textwidth}{!}{
    \begin{tabular}{|c|c|c|c|c|c|c|c|c|}
      ...
      \multirow{3}{*}{\begin{tabular}[c]{@{}c@{}}Model\\ 1\end{tabular}} & PFI              & 1 00                                                      & 0.50                                                              & 0.00                                                             & 0.48                                                              & 0.86                                                      & 0.87                                                      & 0.46                                                            \\ \cline{2-9}
                                                                         & Wagi wejściowe   & 1.00                                                      & 0.19                                                              & 0.28                                                             & 0.37                                                              & 0.41                                                      & 0.03                                                      & 0.00                                                            \\ \cline{2-9}
      ...
      \multirow{3}{*}{\begin{tabular}[c]{@{}c@{}}Model\\ 2\end{tabular}} & PFI              & 1 00                                                      & 0.62                                                              & 0.00                                                             & 0.13                                                              & 0.58                                                      & 0.73                                                      & 0.11                                                            \\ \cline{2-9}
                                                                         & Wagi wejściowe   & 0.80                                                      & 0.76                                                              & 0.28                                                             & 1.00                                                              & 0.70                                                      & 0.24                                                      & 0.05                                                            \\ \cline{2-9}
