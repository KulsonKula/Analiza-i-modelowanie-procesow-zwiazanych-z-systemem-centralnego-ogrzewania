...
Kolejnym wymaganiem jest aby wybrana techonologia była ciągle wspierana i aktualizowana. Machine learning jest aktulanie jedną z najszyciej rozwijających sie dziedzin programowania, co wiąże sie z szybkimi zmianami.(DOPISAĆ COŚ TUTAJ)\\
\begin{itemize}
	\item R
	\item Python
\end{itemize}
...
W ramach procesu dostowania formatu aby przystosować go do wymagań tensorflow, dzień tygodnia zostal zamieniona na etykiete liczbową, która przyjmuje wartośc od 1 do 7, co odpowiada kolejnym dniom tygodnia, podobny proces został zastosowany do pór roku. Każda została zakodowana jako etykieta w zakresie od 1 do 4 co prezentuje kolejno, wiosne, lato, jesień i zimę. Dodatkowo został wyodrębniony procent dnia.
\section{Projektowanie i ocena modeli}
Opisanie prob wybrania modelu testowe, oraz na jakich zbiorach były uczone. Wyniki symulacji i przeprowadzanych testów.
Wybór najlepszego modelu, dostrajanie go. Przedstawienie końcowych wyników, plotowanie rzeczy typu wykres loss od czasu.
% \begin{itemize}
