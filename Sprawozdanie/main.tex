...
Uczenie maszynowe, ważność warunków atmosferyczych, modelowanie dynamiki temperatury
...
\begin{otherlanguage}{british}
  Machine learning, importance of atmospheric conditions, temperature dynamics modeling
\end{otherlanguage}
...
V. Bakker et al.\cite{bib:model_przewidywania} wykorzystali sieci nueronowe do prognozowania zapotrzebowania na energię eletryczną w gospodarstwie domowym. Zaproponowany dodel był trzywarstwowy, posiadający trzy wejscia, zapotrzebowanie na ciepło z poprzedniego dnia oraz z poprzedniego tygodnia i prognozowanę średniej temperatury w ciągu dnia. Sieć posiadała 24 wyjścia, reprezentujące prognoze zapotrzebowania na ciepło przypadające na każdą godzine dnia. Autorzy sugerują że rozbudowe modelu o dodatkowe parametry takie jak prędkość wiatru lub ustawienia termostatu mogło by znacząco poprawić jakość predykcji.
