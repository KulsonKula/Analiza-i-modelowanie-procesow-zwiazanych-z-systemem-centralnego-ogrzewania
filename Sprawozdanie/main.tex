...
\begin{table}[!h]
  \centering
  \caption{Porównianie wartości MSE dla każdego z modeli}
  \renewcommand{\arraystretch}{1.5}
  \resizebox{\textwidth}{!}{
