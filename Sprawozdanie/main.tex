...
\begin{equation}
  J(t) = \int_{0}^{T} \left( T_{wo} - T_{wym} \right)^2 \left| \frac{\text{sign}(T_{wo} - T_{wym} - \delta) + \text{sign}(T_{wo} - T_{wym} + \delta)}{2} \right| \, dt
\end{equation}
gdzie:
\begin{itemize}
  \item[$T_{wo}$] Temperatura wyjściowa
